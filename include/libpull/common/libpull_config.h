/* include/libpull/common/libpull_config.h.  Generated from libpull_config.h.in by configure.  */
#ifndef LIBPULL_CONFIG_H_
#define LIBPULL_CONFIG_H_
